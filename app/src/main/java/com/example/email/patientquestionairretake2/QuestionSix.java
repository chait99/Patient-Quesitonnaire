...
public class QuestionSix extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int dp = (int) (getResources().getDimension(R.dimen.dimQ6) / getResources().getDisplayMetrics().density);
        ...
        NextQ.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (ScoreNumber == 0) {
                    ...
                    startActivity(new Intent(getApplicationContext(), QuestionSeven.class));
                }
                if (ScoreNumber == 1) {

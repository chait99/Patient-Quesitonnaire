...
public class QuestionSeven extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Question = (TextView) findViewById(R.id.Q1TV);Resources res = getResources();
        int dp = (int) (getResources().getDimension(R.dimen.dimQ) / getResources().getDisplayMetrics().density);
        ...
        NextQ.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (ScoreNumber == 0) {
                    ...
                    startActivity(new Intent(getApplicationContext(), QuestionEight.class));
                }
                if (ScoreNumber == 1) {
